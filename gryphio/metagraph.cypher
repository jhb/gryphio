...
create (_sem_prop:`Sem_Relation` {`description`:"Sem_Label --SEM_PROP-> Sem_Property", `techname`:"SEM_PROP",`_uid`:"sem5"})
...
create (_schemaname:`Sem_Property` {`description`:"the name of a schema", `scalartype`:"string", `techname`:"_schemaname",`_uid`:"sem36"})


create (_sem_label)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem18"}]->(_description)
create (_sem_label)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem19"}]->(_techname)
create (_sem_label)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem20"}]->(_uid)
create (_sem_label)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem37"}]->(_schemaname)

create (_sem_prop)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem21"}]->(_arity)
create (_sem_prop)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem23"}]->(_uid)

create (_sem_relation)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem25"}]->(_techname)
create (_sem_relation)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem26"}]->(_description)
create (_sem_relation)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem27"}]->(_uid)

create (_sem_property)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem28"}]->(_scalartype)
create (_sem_property)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem29"}]->(_description)
create (_sem_property)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem30"}]->(_techname)
create (_sem_property)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem31"}]->(_uid)

create (_person)-[:`SEM_PROP` {`arity`:"?",`_uid`:"sem32"}]->(_lastname)
create (_person)-[:`SEM_PROP` {`arity`:"?",`_uid`:"sem33"}]->(_firstname)
create (_person)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem34"}]->(_name)
create (_person)-[:`SEM_PROP` {`arity`:"1",`_uid`:"sem35"}]->(_uid)
